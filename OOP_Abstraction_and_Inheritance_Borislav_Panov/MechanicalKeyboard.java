public class MechanicalKeyboard extends Keyboard implements Brand, Backlight, Connectivity {
    ...
    public MechanicalKeyboard(String switchType, int sizePercentage) {
